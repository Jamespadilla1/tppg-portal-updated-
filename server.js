...
app.use('/api/unit-managers',  require('./routes/unitManagers'));
...
app.use('/api/sales-target', require('./routes/salesTarget'));
app.use('/api/commission-receivables', require('./routes/receivables'));
